...
if __name__ == '__main__':
    # main(1, [0.01, 0.25, 0.50, 0.75, 0.95])
    main(5, [0.01, 0.25, 0.50, 0.75, 0.95])
    main(10, [0.01, 0.25, 0.50, 0.75, 0.95])
    main(15, [0.01, 0.25, 0.50, 0.75, 0.95])
    main(20, [0.01, 0.25, 0.50, 0.75, 0.95])
    main(25, [0.01, 0.25, 0.50, 0.75, 0.95])
    main(30, [0.01, 0.25, 0.50, 0.75, 0.95])